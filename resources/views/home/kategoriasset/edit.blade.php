                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-header bg-white">
                                <h4 class="card-tile">Halaman Edit Data</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{route('kategoriasset.update',['kategoriasset'=> $kategoriasset->id])}}" method="post" class="form-sample">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text"
                                                        name="nama_kategori" value="{{$kategoriasset->nama_kategori}}"
                                                        placeholder="Masukan"
