                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-link" data-toggle="modal" data-target="#saranModal{{$loop->index}}">
                                                        Lihat saran
                                                    </button>
                                                    <div class="modal fade" id="saranModal{{$loop->index}}" tabindex="-1" role="dialog" aria-labelledby="saranModalLabel{{$loop->index}}" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="saranModalLabel{{$loop->index}}">Detail Saran</h5>
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-outline-primary" data-dismiss="modal">Tutup</button>
                                                        <a href="/ticket" class="btn btn-primary"><i class="fas fa-paper-plane mr-2"></i> Kirim</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#pendingModal">
                                        ...
                                        <div class="modal fade" id="pendingModal" tabindex="-1" role="dialog" aria-labelledby="pendingModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/pending/post" method="post">
                                                            <div class="form-group">
                                                                <label for="pendingTextarea" class="left-align-label">Alasan pending :</label>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-outline-primary" data-dismiss="modal">Tutup</button>
                                                        <a href="{{ route('ticket.pending', $ticket->id) }}" class="btn btn-primary"><i class="fas fa-paper-plane-o mr-2"></i> Kirim</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
