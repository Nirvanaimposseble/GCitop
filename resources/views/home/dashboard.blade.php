        ...
        <div class="col-md-12 grid-margin">
          <div class="row">
            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
              <h3 class="font-weight-bold">Welcome Dude!</h3>
        ...
        <div class="col-md-6 grid-margin transparent">
          <div class="row">
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class="card card-tale">
                <div class="card-body">
                  <p class="mb-4">Total Ticket</p>
                  <p class="fs-30 mb-2">{{ $total_ticket }}</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class="card card-dark-blue">
                <div class="card-body">
                  <p class="mb-4">Total On Proccess</p>
          ...
          <div class="row">
            <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
              <div class="card card-dark-warning">
                <div class="card-body">
            ...
            <div class="col-md-6 stretch-card transparent">
              <div class="card card-light-success">
                <div class="card-body">
                  <p class="mb-4">Finished</p>
                  <p class="fs-30 mb-2">{{ $beres }}</p>
                </div>
              </div>
            </div>
          </div>
