                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('asset.store')}}" method="POST" class="form-sample">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="kategoriasset_id" class="form-control @error('kategoriasset_id') is-invalid @enderror">
